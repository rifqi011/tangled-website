            ...
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mt-6 flex space-x-4">
                        <form method="POST" action="{{ route('lost-item-found.found', $item->slug) }}">
                            @csrf
                            <button type="submit" class="inline-flex items-center rounded-md bg-purple px-4 py-2 text-white">Found</button>
                        </form>
                        <a href="{{ route('lost-item-found') }}" class="inline-flex items-center rounded-md bg-gray-200 px-4 py-2 text-gray-700 hover:bg-gray-300">Back</a>
                    </div>
                </div>
            </div>
        </div>
