                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admins.update', $admin) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" class="mt-1 block w-full" type="text" name="name" :value="old('name', $admin->name)" required autofocus />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="email" class="mt-1 block w-full" type="email" name="email" :value="old('email', $admin->email)" required />
